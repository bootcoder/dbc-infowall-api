...
class CalendarAdapter
  ...
  def sanitize_name(name, event)
    ...
    return "Frank" if event.raw["creator"]["email"] == "sally.attaalla@devbootcamp.com" || event.raw["creator"]["email"] == "jenny@devbootcamp.com" || event.raw["creator"]["email"] == "frank.gonzalez@devbootcamp.com" || event.title.include?('White-boarding')
